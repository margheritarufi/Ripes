...
extern std::map <unsigned int, unsigned long long> regsInitForHwDescription; // = Ripes::ProcessorRegistry::getDescription(globalID).defaultRegisterVals; //as it is called by _selectProcessor in processorhandler.cpp before launching the gui)
